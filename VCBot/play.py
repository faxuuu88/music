...
from VCbot.helpers.other.generator.chattitle import CHAT_TITLE
from VCbot.helpers.other.generator.thumbnail import gen_thumb
from VCbot.helpers.queues import QUEUE, add_to_queue, get_queue
